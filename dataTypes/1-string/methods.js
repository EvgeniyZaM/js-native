...
// Удаление или замена всех найденных восклицательных знаков (вместо восклицательного знака может быть любая подстрока)
console.log("!h!e!l!l!o!".replace(/!/g, "?")) // ?h?e?l?l?o? (замена на вопросительные знаки)
console.log("!h!e!l!l!o!".replace(/!/g, "")) // hello (удаление)
