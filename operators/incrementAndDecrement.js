...
// ++ (инкремент)
// Постфиксная форма инкремента и декремента (меняет и возвращает старое значение)
...
// -- (декремент)
// Префиксная форма инкремента и декремента (меняет и возвращает новое значение)
